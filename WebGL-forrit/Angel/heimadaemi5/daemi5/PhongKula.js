...
window.onload = function init() {
    ...
    gl.uniform4fv(gl.getUniformLocation(program, "ambientProduct_bhinn"), flatten(ambientProduct));
    gl.uniform4fv(gl.getUniformLocation(program, "diffuseProduct_bhinn"), flatten(diffuseProduct));
    gl.uniform4fv(gl.getUniformLocation(program, "specularProduct_bhinn"), flatten(specularProduct));
    gl.uniform1f(gl.getUniformLocation(program, "shininess_bhinn"), materialShininess);
    gl.uniform1f(gl.getUniformLocation(program, "bhinn"), bhinn);
    ...
    document.getElementById("Bhinn-Phong").onclick = function () {
        bhinn = true;
        gl.uniform1f(gl.getUniformLocation(program, "bhinn"), bhinn);
        document.getElementById("Phong").disabled = false;
        document.getElementById("Bhinn-Phong").disabled = true;
    };
    document.getElementById("Phong").onclick = function () {
        bhinn = false;
        gl.uniform1f(gl.getUniformLocation(program, "bhinn"), bhinn);
        document.getElementById("Bhinn-Phong").disabled = false;
        document.getElementById("Phong").disabled = true;
    };
